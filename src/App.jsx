        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          {user ? (
            <div className="flex items-center gap-4">
              ...
              <button onClick={() => { logout(); setCurrentView(VIEW_ALL); setEditingBlog(null);}} className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition">Logout</button>
            </div>
          ) : (
